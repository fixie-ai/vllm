...
class MultiModalRegistry:
    ...
    def register_input(
        ...
        """
        return self._get_plugin_for_data_type(
            data_type).register_input_processor(processor)

    def register_image_pixel_input(
        self,
        processor: Optional[MultiModalInputProcessor[ImagePixelData]] = None,
    ):
        """
    ...
    def register_image_feature_input(
        self,
        processor: Optional[MultiModalInputProcessor[ImageFeatureData]] = None,
    ):
        """
    ...
    def process_input(
        ...
        """
        return self._get_plugin_for_data_type(type(data)).process_input(
            data, model_config, vlm_config)
