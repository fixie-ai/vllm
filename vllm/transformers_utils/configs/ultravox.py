...
class UltravoxConfig(transformers.PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # if isinstance(text_config_obj, transformers.Gemma3TextConfig):
        #     text_config_obj.architectures = ["Gemma3ForCausalLM"]
        # elif isinstance(text_config_obj, transformers.Llama4TextConfig):
        ...
        #     text_config_obj = text_config_obj.get_text_config()
